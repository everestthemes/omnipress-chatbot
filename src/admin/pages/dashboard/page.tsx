							...
							>
										...
										<Tooltip>
											...
											>
												<p className="!text-gray-500">
													Enter your Omnipress api
													Key. You can get it from
													<a
								...
								<div className="space-y-2 flex gap-4 items-center mt-3">
									<Switch
										id="isEnableChatBot"
										checked={
											chatbotSettings?.isEnableChatBot
										}
									...
									<Tooltip>
										...
										>
											<p className="!text-gray-500 mb-2">
												When Enable this option, the
												chatbot will be visible on your
												website.
											</p>
										</TooltipContent>
									</Tooltip>
